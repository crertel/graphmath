defmodule Graphmath.Mat22 do
  ...
  **A****v**. Graphics constructors use row vectors: `transform_vector(a, v)`
  ...
  def apply_left(v, a), do: apply_transpose(a, v)

  @doc """
  Returns **v****A**<sup>T</sup>, equivalent to `apply(a, v)`.
  """
  @spec apply_left_transpose(vec2, mat22) :: vec2
  def apply_left_transpose(v, a), do: __MODULE__.apply(a, v)
  ...
  def transform_vector(a, v), do: apply_transpose(a, v)
  ...
  def inverse({a11, a12, a21, a22} = a) do
    inv_det = 1.0 / determinant(a)

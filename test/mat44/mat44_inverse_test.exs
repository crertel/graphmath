defmodule Graphmath.Mat44.Inverse_Mat44 do
  use ExUnit.Case
  ...
  test "A * inverse(A) == I" do
    ...
    assert Graphmath.Mat44.round(Graphmath.Mat44.multiply(a, inverse_a), 1) == Graphmath.Mat44.identity()
  end
  ...
  test "inverse(A) == B" do
      ...
      assert m == { -5/2,    3,    -6,   1/2,
                  -17/10, 12/5, -23/5,  3/10,
                       1,   -1,     2,     0,
                   -1/10,  1/5,   1/5, -1/10}
  end
